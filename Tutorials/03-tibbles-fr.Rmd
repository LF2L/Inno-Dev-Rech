...
Oups ! Qu'est-ce qui se passe? `r emo::ji("sad")`
...
Vous n'avez pas à vous soucier des tibbles dans ces modules.
Dans les futurs modules, nous convertirons automatiquement chaque jeu de données en un tableau interactif. 

Cependant, *envisagez de faire des tibbles dès que possible quand vous travaillez dans R.*
